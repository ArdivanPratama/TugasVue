<template>
  <nav
    id="header"
    class="w-full top-10 py-1 bg-white shadow-lg border-b border-blue-400"
  >
            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-4 py-3 border">
                    <button
                      class="bg-red-500 py-1 px-2 rounded-lg text-white"
                    ...
                    /
                    <button
                      class="bg-yellow-500 py-1 px-2 rounded-lg text-white"
